...
const PostOne = () => {
  ...
  const { id } = useParams();
  const productCrud = new Crud("news");
        ...
        <>
          ...
          <div class="container text-center">
            ...
            <div class="row">
              <div class="col">
                <a
                  href={`${process.env.REACT_APP_MARMELAD_STORE_API_URL}${product.image}`}
                  target="_blank"
                >
                  <img
            ...
            <div class="row mt-3">
              ...
              <div class="col text-center border border-success rounded text-light bg-secondary">
                <p>Автор: {product.author}</p>
                <p>Тема: {product.theme}</p>
